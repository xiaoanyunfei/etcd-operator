...
type EtcdClusterInterface interface {
	...
	Apply(ctx context.Context, etcdCluster *etcdv1beta2.EtcdClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1beta2.EtcdCluster, err error)
	ApplyStatus(ctx context.Context, etcdCluster *etcdv1beta2.EtcdClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1beta2.EtcdCluster, err error)
...
// Apply takes the given apply declarative configuration, applies it and returns the applied etcdCluster.
func (c *etcdClusters) Apply(ctx context.Context, etcdCluster *etcdv1beta2.EtcdClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1beta2.EtcdCluster, err error) {
	if etcdCluster == nil {
		return nil, fmt.Errorf("etcdCluster provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
	data, err := json.Marshal(etcdCluster)
	if err != nil {
		return nil, err
	}
	name := etcdCluster.Name
	if name == nil {
		return nil, fmt.Errorf("etcdCluster.Name must be provided to Apply")
	}
	result = &v1beta2.EtcdCluster{}
...
func (c *etcdClusters) ApplyStatus(ctx context.Context, etcdCluster *etcdv1beta2.EtcdClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1beta2.EtcdCluster, err error) {
	if etcdCluster == nil {
		return nil, fmt.Errorf("etcdCluster provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
